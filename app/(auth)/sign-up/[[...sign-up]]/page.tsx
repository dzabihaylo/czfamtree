    ...
    <SignUp
      ...
      appearance={{
        ...
        elements: {
          ...
          formFieldInput:
            'border border-rule bg-bg-card rounded-none text-[14px] py-sm px-md focus:border-accent focus:outline-none',
          formFieldLabel: 'text-ink text-[13px] font-semibold',
          formButtonPrimary:
            'border border-ink bg-ink text-bg-card rounded-none text-[13px] font-semibold py-sm px-[14px] hover:-translate-x-[2px] hover:-translate-y-[2px] hover:shadow-[4px_4px_0_var(--accent)] transition-all duration-150',
          footer: 'bg-bg mt-lg',
